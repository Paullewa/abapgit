class ZCL_ZGW_F_BOOKING_MPC definition
  public
...
public section.
  ...
  types:
     TS_ZBOOK_SPFLI type ZBOOK_SPFLI .
  types:
TT_ZBOOK_SPFLI type standard table of TS_ZBOOK_SPFLI .
  types:
  ...
  constants GC_ZBOOK_SPFLI type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'ZBOOK_SPFLI' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZGW_F_BOOKING_MPC=========CP' ##NO_TEXT.

  methods DEFINE_ZBOOK_SPFLI
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
ENDCLASS.
...
CLASS ZCL_ZGW_F_BOOKING_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZGW_F_BOOKING_SRV' ).

define_zbook_spfli( ).
  endmethod.


  method DEFINE_ZBOOK_SPFLI.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'ZBOOK_SPFLI' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZBOOK_SPFLI'
...
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'ZBOOK_SPFLISet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20230602061420'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'ZBOOK_SPFLI'.                            "#EC NOTEXT
